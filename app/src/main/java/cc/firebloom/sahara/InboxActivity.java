...
public class InboxActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Cursor c = getContentResolver().query(Sahara.SMS.INBOX_URI,
                new String[]{Sahara.SMS.THREAD_ID, Sahara.SMS.ADDRESS, Sahara.SMS.SUBJECT,
                        Sahara.SMS.BODY},
        ...
        if (null != c) {
            ...
            SparseArray<ArrayList<String>> threads = new SparseArray<ArrayList<String>>(c
                    .getCount());
...
//        Log.i("> w <", "---------");
            ...
            for (int i = threads.size() - 1; i >= 0; i--) {
                ...
                map.put(BLOCKED, sender.shouldBlockNumber(number) ? getString(R.string
                        .inbox_blocked) : getString(R.string.inbox_unblocked));

                data.add(map);
            }

            _adapter = new InboxAdapter(this, data, R.layout.inbox_list_item,
                    new String[]{NUMBER, CONTENT, BLOCKED}, new int[]{R.id.title, R.id.content,
                    R.id.blocked});
